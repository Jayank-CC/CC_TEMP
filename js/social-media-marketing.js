(function () {
  ...
  function reviewCarousel() {
    const viewport = document.querySelector(".smm-review-viewport");
    const track = document.querySelector(".smm-review-track");
    ...
    function measure() {
      const card = track.querySelector(".smm-review-card");
      if (!card) return;
  ...
  if (window.__smmPageInit) {
    init();
  } else {
    window.__smmPageInit = true;
    if (document.readyState === "loading") {
