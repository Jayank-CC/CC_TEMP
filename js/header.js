...
<header class="site-header" id="site-header">
  <div class="header-inner">
    ...
    <!-- "Minimal header" variant content -- hidden by default (css/style.css), shown only when
         the page opts in via a "has-minimal-header" class on <body> (landing/campaign pages that
         reproduce the reference's own stripped header: logo + contact line, no nav/CTA). -->
    <div class="header-contact-bar">
      <a class="header-contact-phone" href="tel:+15855660511">
      ...
      <a class="header-contact-email" href="mailto:info@cloudconverge.io">
        <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M4 4h16v16H4z" opacity="0"></path><path d="M22 6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6zm-2 0-8 5-8-5"></path></svg>
