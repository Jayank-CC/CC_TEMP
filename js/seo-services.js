(function () {
  ...
  function reviewCarousel() {
    const viewport = document.querySelector(".seo-review-viewport");
    const track = document.querySelector(".seo-review-track");
    ...
    function measure() {
      const card = track.querySelector(".seo-review-card");
      if (!card) return;
  ...
  if (window.__seoPageInit) {
    init();
  } else {
    window.__seoPageInit = true;
    if (document.readyState === "loading") {
