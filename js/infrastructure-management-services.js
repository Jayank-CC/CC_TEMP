(function () {
  ...
  function reviewCarousel() {
    const viewport = document.querySelector(".ims-review-viewport");
    const track = document.querySelector(".ims-review-track");
    ...
    function measure() {
      const card = track.querySelector(".ims-review-card");
      if (!card) return;
  ...
  if (window.__infrastructureManagementServicesPageInit) {
    init();
  } else {
    window.__infrastructureManagementServicesPageInit = true;
    if (document.readyState === "loading") {
