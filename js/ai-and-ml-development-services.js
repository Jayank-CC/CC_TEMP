(function () {
  ...
  function reviewCarousel() {
    const viewport = document.querySelector(".aiml-review-viewport");
    const track = document.querySelector(".aiml-review-track");
    ...
    function measure() {
      const card = track.querySelector(".aiml-review-card");
      if (!card) return;
  ...
  if (window.__aimlPageInit) {
    init();
  } else {
    window.__aimlPageInit = true;
    if (document.readyState === "loading") {
