(function () {
  ...
  function reviewCarousel() {
    const viewport = document.querySelector(".bis-review-viewport");
    const track = document.querySelector(".bis-review-track");
    ...
    function measure() {
      const card = track.querySelector(".bis-review-card");
      if (!card) return;
  ...
  if (window.__bisPageInit) {
    init();
  } else {
    window.__bisPageInit = true;
    if (document.readyState === "loading") {
